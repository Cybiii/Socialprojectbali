  ...
  return (
    <>
      <li className='w-1/3 px-4 py-6'> {/* Adjust the width and padding for the card */}
        <Link className='flex flex-col items-center p-6 bg-white border-4 border-indigo-700 shadow-xl hover:shadow-2xl transition-shadow duration-300 rounded-xl' to={props.path}>
