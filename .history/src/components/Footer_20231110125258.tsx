    ...
    <footer className='bg-gray-950 text-white p-8'>
      ...
      <div className='flex flex-wrap justify-between'>
        ...
        <div className='w-full sm:w-auto mb-6 sm:mb-0'>
          ...
          <Link to='//www.instagram.com' className='block text-indigo-500 hover:text-purple-500' target='_blank'>Instagram</Link>
          <Link to='//www.facebook.com' className='block text-indigo-500 hover:text-purple-500' target='_blank'>Facebook</Link>
          <Link to='//www.youtube.com' className='block text-indigo-500 hover:text-purple-500' target='_blank'>Youtube</Link>
        </div>
      </div>
