  ...
  return (
    <div className="mx-auto">
      <div className="flex flex-col md:flex-row bg-white">
        <div className="md:w-full bg-cover bg-center bg-[url('/images/Volunteer_Main.png')] text-center p-6 rounded-l-lg">
          <h1 className="text-4xl font-bold text-violet-950 mb-4">VOLUNTEER WITH US!</h1>
          <p className="text-2xl text-center text-black mb-4">
