  ...
  return (
    <div className="container mx-auto p-4">
      <div className="flex flex-col md:flex-row">
        ...
        <div className="md:w-1/2 bg-blue-200 text-center p-6 rounded-l-lg">
          ...
          <button className="text-violet-950 text-white text-lg py-2 px-4 rounded hover:bg-purple-700 transition duration-300">
