  ...
  return (
    <div className="bg-gray-100 p-6">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <p className="mb-4 text-lg text-gray-700">Your support enables us to continue our mission in Bali, providing education and resources to those in need. Every donation, big or small, contributes to making a lasting impact.</p>
