                ...
                return (
                    <>
                        ...
                        <div className="flex-1 space-y-4">
                            <h2 className="text-5xl font-bold text-violet-950">OUR MISSION</h2>
            ...
            case 'vision':
                return (
                    <>
                        ...
                        <div className="flex-1 space-y-4">
                            <h2 className="text-5xl font-bold text-violet-950">OUR VISION</h2>
                            <p className="text-3xl text-black">
            ...
            case 'join':
                return (
                    <>
                        ...
                        <div className="flex-1 space-y-4">
                            <h2 className="text-5xl font-bold text-violet-950">JOIN US</h2>
                            <p className="text-3xl text-black">
    ...
    return (
        <div className="flex flex-col items-center p-16 space-y-16 bg-white w-full">
            <div className="text-center space-y-8 border-b pb-8 w-3/4">
                <h1 className="text-6xl font-bold text-violet-950">ABOUT US</h1>
                <p className="text-center text-black text-3xl mx-auto">
