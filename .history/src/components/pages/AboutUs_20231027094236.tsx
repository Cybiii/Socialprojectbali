        ...
        <div className="flex flex-col items-center p-16 space-y-12 bg-white">
            ...
            <div className="text-center space-y-4">
                ...
                <div className="flex space-x-4">
                    <button className="bg-violet-950 text-white text-3xl py-2 px-4">MISSION</button>
                    <button className="bg-violet-950 text-white py-2 px-4">VISION</button>
                    <button className="bg-violet-950 text-white py-2 px-4">SPONSORS</button>
                </div>
            </div>
