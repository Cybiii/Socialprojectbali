...
export default function History() {
  return (
    <div className="container mx-auto p-4">
      ...
      <ImageWithText alt="Group of students" imageName="History_1.jpg">
      ...
      <ImageWithText alt="Volunteers group photo" imageName="History_2.jpg">
        Established on September 19, 2020, Social Project Bali has been on a continuous 
        journey of growth and community engagement.
      </ImageWithText>
      <ImageWithText alt="Local community members" imageName="History_3.jpg">
