        ...
        <div className="flex flex-col items-center p-16 space-y-12 bg-white">
            ...
            <div className="text-center space-y-4">
                ...
                <div className="flex space-x-4">
                    <button className="bg-orange-600 text-white py-2 px-4 rounded-full">MISSION</button>
                    <button className="bg-orange-600 text-white py-2 px-4 rounded-full">VISION</button>
                    <button className="bg-orange-600 text-white py-2 px-4 rounded-full">SPONSORS</button>
                </div>
            </div>

            <div className="flex flex-col items-center space-y-4 w-3/4">
                <img src="images/AboutUs_Image.png" alt="Mountain Image" className="w-full rounded-lg shadow-md"/>
                <h2 className="text-3xl font-bold text-orange-600">SED AC URNA SIT AMET LOREM</h2>
