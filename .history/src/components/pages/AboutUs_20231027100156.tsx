    ...
    const renderSection = () => {
        switch(section) {
            case 'mission':
                return (
                    <>
                        <img src="images/AboutUs_1.png" alt="Mission Image" className="w-1/2 rounded-lg shadow-md"/>
            ...
            case 'join':
                return (
                    <>
                        <img src="images/AboutUs_3.png" alt="Join Us Image" className="w-1/3 rounded-lg shadow-md"/>
                        <div className="flex-1 space-y-4">
        ...
        <div className="flex flex-col items-center p-16 space-y-12 bg-white w-full">
            <div className="text-center space-y-4 w-3/4">
                ...
                <div className="flex space-x-4 justify-center">
                    <button onClick={() => setSection('mission')} className="bg-violet-950 hover:bg-violet-800 text-white text-2xl py-2 px-4 rounded">MISSION</button>
                    <button onClick={() => setSection('vision')} className="bg-violet-950 hover:bg-violet-800 text-white text-2xl py-2 px-4 rounded">VISION</button>
                    <button onClick={() => setSection('join')} className="bg-violet-950 hover:bg-violet-800 text-white text-2xl py-2 px-4 rounded">JOIN US</button>
                </div>
            </div>
