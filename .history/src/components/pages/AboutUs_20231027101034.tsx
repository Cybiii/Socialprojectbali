    ...
    const renderSection = () => {
        switch(section) {
            case 'mission':
                return (
                    <>
                        <img src="images/AboutUs_1.png" alt="Mission Image" className="w-2/5 h-4/5 overflow-hidden rounded-lg shadow-md"/>
            ...
            case 'vision':
                return (
                    <>
                        <img src="images/AboutUs_2.png" alt="Vision Image" className="w-2/5 h-4/5 overflow-hidden rounded-lg shadow-md"/>
                        <div className="flex-1 space-y-4">
