    ...
    return (
        <div className="flex flex-col items-center p-16 space-y-12 bg-white">
            ...
            <div className="text-center space-y-4">
                ...
                <p className="w-3/4 text-center text-black mx-auto">
                ...
                <div className="flex space-x-4">
                    <button className="bg-violet-950 text-white text-lg py-2 px-4">MISSION</button>
                    <button className="bg-violet-950 text-white text-lg py-2 px-4">VISION</button>
                    <button className="bg-violet-950 text-white text-lg py-2 px-4">JOIN US</button>
                </div>
            </div>

            <div className="flex flex-col items-center space-y-4 w-3/4">
                <img src="images/AboutUs_1.png" alt="About Us" className="w-full rounded-lg shadow-md"/>
