  ...
  return (
    <div className="w-full h-[75vh] relative overflow-hidden">
      {images.map((imgSrc, idx) => (
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(180deg, rgba(0, 0, 0, 0.92) 0%, rgba(29, 0, 77, 0.69) 37.5%, rgba(217, 217, 217, 0) 100%)",
            }}
          ></div>
        </div>
      ))}
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center w-4/5">
        ...
        <p className="text-white text-3xl mx-auto mb-8">
          A Bali-based non-profit organization dedicated to advancing education,
          environmental conservation, and promoting social welfare.
        </p>
        <div>
          <Button
            className="btns"
